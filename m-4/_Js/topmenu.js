...
var mainNavi_H = {
    ...
    $("li", $(this.mnObj)).each(function () {
      ...
      if (sLI.length > 0) {
        if ($(this).find(" > .tgl-btn").length < 1) {
          $(this).prepend(
            "<button class='tgl-btn' type='button'>ToggleMenu</button>"
          );
        }
  ...
  setMenuBar: function (n) {
    ...
    if (this.ovbar != undefined) {
      var toLeft =
        thisMenu != null
          ? thisMenu.offset().left - $(this.mnObj).offset().left
          : 0;
  ...
  clearEvt: function () {
    ...
    $(".depth2-wrap", $(this.mnObj)).unbind(
      "mousedown mouseover click focus mouseout blur"
    );
    $("> li > .depth2-wrap", $(this.mnObj)).unbind(
      "mousedown mouseover click focus mouseout blur"
    );
  ...
  setBodyContainer: function () {
    if (typeof this.setBodyCont == "undefind" || this.setBodyCont != true) {
      ...
      if ($(".header-ovclick").length < 1)
        $("<div class='header-ovclick'/>").appendTo($("#header")).hide();
      if ($(".doc-pg").find(".body-slide-wr") == false) {
        $(".doc-pg")
          .stop()
          .wrapInner(
            "<div class='body-slide-wr'><div class='body-slide'></div></div>"
          );
      }
    }
  },
  ...
  _initOvNum: function (initNum) {
    if (initNum != undefined) this.initNum = initNum;
      ...
      this.initNum[0] =
        $(".mn_l1.over", this.mnObj).length > 0
          ? $(".mn_l1.over", this.mnObj).index() + 1
          : 0;
      this.initNum[1] =
        $(".mn_l2.over", this.mnObj).length > 0
          ? $(".mn_l2.over", this.mnObj).index() + 1
          : 0;
      this.initNum[2] =
        $(".mn_l3.over", this.mnObj).length > 0
          ? $(".mn_l3.over", this.mnObj).index() + 1
          : 0;
    }
  },
