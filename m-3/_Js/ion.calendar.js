                ...
                var prepareCalendar = function(){
                    ...
                    for(i = 0; i < 12; i++){
                        if(i === parseInt(timeNowLocal.format("M")) - 1){
                            html += '<option value="' + i + '" selected="selected">' + timeForWork.month(i).format("MM") + '월'+'</option>';
                        } else {
                            html += '<option value="' + i + '">' + timeForWork.month(i).format("MM") + '월'+'</option>';
                        }
                    }
                    html += '</select></div>';
					...
					html += '<div class="ic__foot"><a href="#n" class="ic__close"><span>닫기</span></a></div>';
                    html += '</div>';
        ...
        init: function(options){
            ...
            return this.each(function(){
                ...
                var openPopup = function(){
                    ...
                    $popup.css({"top":"25px"});
					//$popup.css("left", (x + w - w - 9) + "px").css("top", (y + 22) + "px");
